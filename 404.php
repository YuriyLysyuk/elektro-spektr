...
function genesis_404()
{
	...
	$genesis_404_content = 'Страница, которую вы ищете, больше не существует. Попробуйте перейти на <a href="' . esc_url(trailingslashit(home_url())) . '">главную страницу</a> или воспользуйтесь поиском ниже.';
